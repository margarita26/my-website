...
export const SocialMediaBar: React.FC = () => {
  return (
    <StyledDiv>
      <StyledLink href="https://www.instagram.com/margarita_gbnva/" target="_blank" rel="noopener noreferrer">
      ...
      <StyledLink href="https://www.linkedin.com/in/margarita-gubanova/" target="_blank" rel="noopener noreferrer">
